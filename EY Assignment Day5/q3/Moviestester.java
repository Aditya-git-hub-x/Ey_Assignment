...
public class Moviestester {
	public static void main(String[] args) {
		...
		Movies m1= new Movies("pushpha","27-07","allu","arjun",2.45);
		Movies m2= new Movies("Bahubali","27-07","prashanth","dvv",2.45);
		Movies m3= new Movies("lamhe","27-07","sagar","Trivikram",2.30);
